...
import 'package:newsapp/Constant/ConstantVariable.dart';
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget> [
            ...
            Text(nameAndImageOfCategoricalBar[widget.index].nameOfCategorical,style: TextStyle(fontWeight: FontWeight.normal),),
          ],
        ),
      ),
    );
